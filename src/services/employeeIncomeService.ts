...
// // Calculate totals for an income record
...
// export const getEmployeeIncomes = async (
//   filters?: EmployeeIncomeFilters
...
//             income => income.employeeId === filters.employeeId
//           );
//         }

//         if (filters.department) {
//           filteredIncomes = filteredIncomes.filter(
//             income => income.department === filters.department
//           );
//         }

//         if (filters.period) {
//           filteredIncomes = filteredIncomes.filter(
//             income => income.period === filters.period
//           );
//         }

//         if (filters.paymentStatus) {
//           filteredIncomes = filteredIncomes.filter(
//             income => income.paymentStatus === filters.paymentStatus
//           );
//         }
//       }
...
// export const getEmployeeIncomeById = async (
//   incomeId: string
// ): Promise<EmployeeIncome | null> => {
...
// export const createEmployeeIncome = async (
//   incomeData: CreateEmployeeIncomeInput
// ): Promise<EmployeeIncome> => {
//   // In real app: return await api.post('/employee-incomes', incomeData);
//   return new Promise((resolve) => {
//     setTimeout(() => {
//       // Generate IDs for income and deduction items
//       const incomeItems = incomeData.incomeItems.map(item => ({
//         ...item,
//         id: generateId()
//       }));

//       const deductionItems = incomeData.deductionItems.map(item => ({
//         ...item,
//         id: generateId()
//       }));
...
//         if (
//           incomeData.paymentStatus === 'Completed' &&
//           currentIncome.paymentStatus !== 'Completed'
//         ) {
